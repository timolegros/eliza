...
export const commonShouldRespondTemplate =
...
{{agentName}} is in a Common thread with other users and is very mindful about not being disruptive.
...
- Are general thread or comment chatter
...
export const commonMessageHandlerTemplate =
    `# Action Examples
{{actionExamples}}
...
# Task: Generate dialog and actions for the character {{agentName}} on Common.
About {{agentName}}:
{{bio}}
{{lore}}
